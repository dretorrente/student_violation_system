<div class="topbar">
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{url('/junior/home')}}" class="logo"><i class="md md-assignment-ind"></i> <span>P.O.D. </span></a>
        </div>
    </div>
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    <li class="dropdown hidden-xs">
                        <a href="#" data-target="#" class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="true">
                            ...
                            <span class="badge badge-xs badge-danger">@if(Helper::junior_students_offense()['count'] > 0)
                                    {!! Helper::junior_students_offense()['count'] !!}
                                @endif</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg">
                            @if(Helper::junior_students_offense()['count'] > 0)
                                <li class="text-center notifi-title">Notification for Student
                                    with 3 offenses</li>
                                <li class="list-group">
                                    @foreach(Helper::junior_students_offense()['student_offense'] as $student)
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{url('/junior/settings')}}"><i class="md md-settings"></i> Settings</a></li>
